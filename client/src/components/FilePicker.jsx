...
class FilePicker extends Component
{
    ...
    render ()
    {
        return (
        <div>
            <input type="file" id="siofu_input" onChange={ (e) => this.handleChange(e.target.files) } ref={ref=> this.fileInput = ref}/><br/>
            Name: <input type="text" value={this.state.value} onChange={this.handleInputChange}/><br/>
